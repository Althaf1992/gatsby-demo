  ...
  return(
    <main>
        ...
        <header id="header" className="fixed-top">
            ...
            <h1 className="logo mr-auto"><a href="/">DEMO<span>.</span></a></h1>
...
<section id="services" className="services">
  <div className="container" >
    ...
    <div className="row"> 
      ...
      <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0"  data-aos-delay="200">
        <div className="icon-box">
          <div className="icon"><i className="bx bx-file"></i></div>
      ...
      <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0"  data-aos-delay="300">
        <div className="icon-box">
          <div className="icon"><i className="bx bx-tachometer"></i></div>
      ...
      <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4"  data-aos-delay="100">
        <div className="icon-box">
          <div className="icon"><i className="bx bx-world"></i></div>
      ...
      <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4"  data-aos-delay="200">
        <div className="icon-box">
      ...
      <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4"  data-aos-delay="300">
        <div className="icon-box">
